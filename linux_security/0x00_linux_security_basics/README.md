...
- 0-login.sh # print 5 last logins
- 1-active-connections.sh # print active TCP connections
- 2-incoming_connections.sh # allow incoming TCP connections to port 80
...
- 7-scan.sh # scan for website subdomains
